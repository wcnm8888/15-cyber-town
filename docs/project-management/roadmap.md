...
状态：`approved — 用户已于 2026-08-24 确认`。`R-01 / F-001`—`R-06 / F-006` 已分别通过 PR #1—#6 完成交付和归档；F-006 已由 PR #6 squash merge 到 `main` / `origin/main` 的 `3c2059aad7ef5a1e9dd0154ad49d2b0e93f8f47f`。F-007 Step 7 已完成；固定视口 P2 已关闭，三 NPC 真实窗口 UAT 与最终本地门禁通过，Git 交付已获授权并进行中。
...
| R-07 | 多 NPC 与隔离（`F-007`，Git 交付） | 学习 namespace 与共享 client；玩家可与不同角色交互 | 3 个固定 NPC、独立状态；不做自主对话 | 会话/记忆泄漏、限流 | 隔离矩阵、并发和 persona 测试 | Git 交付进行中 |
...
`R-01`—`R-06` 已完成并归档。F-007 Step 7 已完成，Git 交付已获授权并进行中。
